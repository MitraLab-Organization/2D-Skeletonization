#!/bin/bash
#
# DM2D Persistence Sweep - STP Dataset
...
LKL_DIR="${DATA_DIR:-/data}/stp/lkl"
GT_DIR="${DATA_DIR:-/data}/stp/GT"
IMG_DIR="${DATA_DIR:-/data}/stp/img"
BASE_DIR="${OUTPUT_DIR:-/outputs}/stp/dm2d_persistence_sweep"
MIN_SIZE=12
