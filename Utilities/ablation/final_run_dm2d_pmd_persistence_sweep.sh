#!/bin/bash
#
# Final DM2D Persistence Sweep - PMD Dataset
...
LKL_DIR="$BASE_PROJECT_DIR/data/pmd/lkl"
GT_DIR="$BASE_PROJECT_DIR/data/pmd/GT"
IMG_DIR="$BASE_PROJECT_DIR/data/pmd/img"
BASE_DIR="$BASE_PROJECT_DIR/outputs/ablation/final_dm2d_output_pmd_persistence_sweep"
MIN_SIZE=40
